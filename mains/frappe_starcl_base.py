...
from data import getdataloader_frappe
...
def main(dataset_name, model_name, epoch, embed_dim, learning_rate,
    ...
    field_dims, trainLoader, validLoader, testLoader = \
        getdataloader_frappe(path="../data/frappe/", batch_size=batch_size)
    print(field_dims)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', default='ml1m', help="")
    parser.add_argument('--save_dir', default='../chkpt/chkpt_frappe/au4ctr', help="") 
